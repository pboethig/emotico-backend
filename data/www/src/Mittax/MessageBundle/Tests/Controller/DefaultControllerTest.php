...
class DefaultControllerTest extends AbstractTest implements IControllerTest
{
    ...
    public function testSend()
    {
         ...
         */
        $responseText = $this->makeRequestWithSampleDataResponse('POST', $this->_bundle, $this->getWsseHeaderOptionsForBodyDataByUsername($this->_adminuser));

...
class StartBatchConsumersCommand extends ContainerAwareCommand
{
    ...
    {
        $this
            ->setName('mittax:mediaconverter:thumbnail:ffmpeg:startbatchconsumers')
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        {
            array_push($processes, new Process('php bin/console mittax:mediaconverter:thumbnail:ffmpeg:startconsumer'));
        }

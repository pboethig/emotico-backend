...
use Mittax\MediaConverterBundle\Repository\Converter\Thumbnail\Ffmpeg\ThumbnailTicket\Consumer;
...
class StartConsumerCommand extends ContainerAwareCommand
{
    ...
    {
        $this
            ->setName('mittax:mediaconverter:thumbnail:ffmpeg:startconsumer')
